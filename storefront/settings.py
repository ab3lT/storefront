...
SECRET_KEY = 'django-insecure-yt#x)hfk@8_-4y#n*mr@zbvpt3$na61&a_1i#1sv21xo^d-w64'
...
INSTALLED_APPS = [
    ...
    'django.contrib.contenttypes', #content type
...
TEMPLATE_DIRS = (
    os.path.join(SETTINGS_PATH, '../playground/template/templates'),
)
